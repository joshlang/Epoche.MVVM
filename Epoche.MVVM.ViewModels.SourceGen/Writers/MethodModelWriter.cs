...
";
    ...
    {{
        ...
        set => this.Set(ref {model.AsyncCommandTaskName.ToCamelCase()}, value, trackChanges: false, cachedPropertyChangedEventArgs: Epoche.MVVM.ViewModels.CachedPropertyChangeEventArgs.{model.AsyncCommandTaskName});
    }}
";
}
